...
// Provider Component
function AuthProviderNew({ children }: { children: ReactNode }) {
...
function useAuthNew() {
  ...
  if (!context) {
    throw new Error("useAuthNew deve ser usado dentro de um AuthProviderNew");
  }
  return context;
}

// Exportar provider e hook
export { AuthProviderNew, useAuthNew, AuthContext };